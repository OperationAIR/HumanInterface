...
def AlarmPop(self, settings):
    ...
    btn1 = Button(popup, textvariable=btn1_text,background='#263655',foreground='white',command=lambda: PeepAlarm(self, settings, btn1_text))
    ...
    btn2 = Button(popup, textvariable=btn2_text,background='#263655',foreground='white', command=lambda: PressureAlarm(self, settings, btn2_text))
    ...
    btn3 = Button(popup, textvariable=btn3_text ,background='#263655',foreground='white', command=lambda: TvAlarm(self, settings, btn3_text))
    ...
    btn4 = Button(popup, textvariable=btn4_text, background='#263655',foreground='white', command=lambda: OxygenAlarm(self, settings, btn4_text))
...
def setAlarmValues(self, settings, popup, valuetype, value, text1, text2):  
    ...
    if valuetype == "MinPressure":  
        if value >= 20 and value < settings.max_pressure:
    ...
    if valuetype == "Minfio2":  
        if value >= 5 and value < settings.max_fio2:
