...
def check_for_anomalies(sensor_frame, max_peep=9.0, min_peep=3.0, max_press=35.0, min_press=30.0, visualize=False):
   ...
   if curr_press < min_peep: return Anomaly.PEEP_TOO_LOW
   if current_phase == 4 and curr_press > max_peep: return Anomaly.PEEP_TOO_HIGH

   # Check for pressure values
   if current_phase == 2 and curr_press < min_press: return Anomaly.PRESS_TOO_LOW
   if curr_press > max_press: return Anomaly.PRESS_TOO_HIGH
